...
mod tests {
    ...
    #[test]
    fn hash_ops_primitive_golden_vectors() {
        assert_eq!(get_str_hash("minecraft:sharpness"), 2734053906);
        assert_eq!(get_str_hash("剣"), 3148226125);
        assert_eq!(get_str_hash("😀"), 1515787531);
        assert_eq!(get_f32_hash(0.0), 4030178044);
        assert_eq!(get_f32_hash(1.5), 2584996756);
    }
